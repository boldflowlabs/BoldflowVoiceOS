...
GOOGLE_REDIRECT_URI = os.getenv(
    "GOOGLE_REDIRECT_URI"
) or (f"{BACKEND_API_ENDPOINT}/api/v1/auth/google/callback" if BACKEND_API_ENDPOINT else "")
...
# Plans / credit packs sold via Razorpay/PayU top-up. 1 credit = 1 call-minute, so
...
CREDIT_PACKS = [
    {
        ...
        "max_languages": 1,
        "includes": [
            "1,000 call credits (minutes)",
            "₹8/min overage rate",
            "1 language supported",
            "AI Voice Agent",
            "Automatic approved WhatsApp template after call",
            "Calendar booking integration",
            "Weekly reports",
            "Standard scaling & concurrency",
            "Standard support & script updates",
        ],
    },
    {
        "id": "growth",
        ...
        "includes": [
            "3,000 call credits (minutes)",
            "₹6/min overage rate",
            "Up to 3 languages supported",
            "AI Voice Agent & Build with AI",
            "Automatic approved WhatsApp template after call",
            "CRM Automation (Zoho, LeadSquared, Practo, GHL)",
            "Calendar booking integration",
            "Analytics dashboard",
            "Peak-hour scaling",
            "Priority WhatsApp support",
            "Priority script changes",
            "REST API access",
        ],
    },
    {
        ...
        "max_languages": 5,
        "includes": [
            "6,000 call credits (minutes)",
            "₹4/min overage rate",
            "Up to 5 languages supported",
            "AI Voice Agent & Build with AI",
            "Advanced WhatsApp automation",
            "CRM Automation (Custom APIs + multi-pipeline & all CRMs)",
            "Calendar booking integration",

  ...
  return (
    <PageShell width="narrow">
      <PageHeader
        ...
        subtitle="Global defaults, telemetry, and Model Context Protocol (MCP) server endpoints."
      />
      ...
      <SectionCard
        ...
        description={
          <>
            Configure Langfuse tracing, LLM token metrics, and real-time call telemetry.{" "}
            <a
